...
(function (window, document, $) {
  ...
  $('.nav-link-style').on('click', function () {
    ...
    if (switchToLayout === 'dark-layout') {
      ...
      $this.find('.ficon').replaceWith(feather.icons['sun'].toSvg({
        "class": 'ficon'
      }));
    } else {
      ...
      $this.find('.ficon').replaceWith(feather.icons['moon'].toSvg({
        "class": 'ficon'
      }));
    }
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\OnePlace\App\resources\js\core\app.js */"./resources/js/core/app.js");
