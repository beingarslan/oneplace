  ...
  <section id="profile-info">
    <div class="row">
      ...
      <div class="col-lg-3 col-12 order-2 order-lg-1">
        ...
        <div class="card">
          <div class="card-body profile-suggestion">
            <h5 class="mb-2"><a href="/university/view/programs"> Programs </a></h5>
            <!-- Program -->
      ...
      <div class="col-lg-3 col-12 order-3">
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="mb-2"><a href="/university/view/departments"> Departments </a></h5>
            ...
            <div class="d-flex justify-content-start align-items-center mt-2">
              ...
              <a href="/university/view/{{$deprtment->id}}/programs" class="btn btn-primary btn-icon btn-sm ml-auto">
        ...
        <div class="card">
          <div class="card-body">
            <h5><a href="/university/manage/announcements">Announcement Feeds</a></h5>
