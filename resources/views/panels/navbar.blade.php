  ...
  <div class="navbar-header d-xl-block d-none">
    <ul class="nav navbar-nav">
      <li class="nav-item">
        ...
        <h2 class="brand-text mb-0">OnePlace</h2>
        </a>
      </li>
    </ul>
  </div>
    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons">
            <!-- <li class="nav-item d-none d-lg-block"><a class="nav-link" href="/university/manage/addmissions" data-toggle="tooltip" data-placement="top" title="Addmissions"><i class="ficon" data-feather="paperclip"></i></a></li> -->
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
          ...
          <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon" data-feather="search"></i></a>
            <div class="search-input">
              ...
              <input class="form-control input" type="text" placeholder="Explore OnePlace..." tabindex="-1" data-search="search">
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav d-sm-flex d-none">
              ...
              <span class="user-status">{{App\UserRole::where('userid', Auth::user()->id)->pluck('name')->first()}}</span>
            </div>
            @if(Auth::user()->userRole->name == 'user')
            <span class="avatar">
              <img class="round" src="{{asset('user/logo/'.\App\UserDetail::where('userid', Auth::user()->id)->pluck('image')->first())}}" alt="avatar" height="40" width="40">
              <span class="avatar-status-online"></span>
            </span>

            @else
            <span class="avatar">
              <img class="round" src="{{asset('university/logo/'.App\UniversityInformation::where('userid', Auth::user()->id)->pluck('logo')->first())}}" alt="avatar" height="40" width="40">
              <span class="avatar-status-online"></span>
            </span>
            @endif
          </a>
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
            ...
            <a class="dropdown-item" href="/user/details/edit/">
              <i class="mr-50" data-feather="user"></i> Profile
            </a>
            @endif
